...
echo "  For /ask via share: bash scripts/05-chat-ask-optional.sh --via-share"
echo "  (installs the p2p peer into a2a-agents.yaml; HTTP file is replaced until you re-run 00)"
