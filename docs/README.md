...
| Topic | English | 中文 |
| --- | --- | --- |
| Quick start (install, init, LLM, first chat) | [getting-started.md](getting-started.md) | [getting-started.zh.md](getting-started.zh.md) |
...
| Agent-to-agent (A2A): when to share a live desktop agent, HTTP vs peer share, how-to | [a2a.md](a2a.md) | [a2a.zh.md](a2a.zh.md) |
